...
adams({
  ...
  // Respond with instructions for setting an auto-reply message
  repondre('To set auto-reply, type .setautoreply followed by your message.\nFor example: .setautoreply Hey, I am currently unavailable.');
});
...
adams({
  ...
  // Process command options and set AUTO_REPLY status
  const option = arg.join(' ').toLowerCase();
  let responseMessage;

  switch (option) {
    case "yes":
      s.AUTO_REPLY = 'enabled';  // Enable AUTO_REPLY_MESSAGE
      responseMessage = 'AUTO_REPLY_MESSAGE has been enabled successfully.';
      break;

    case "no":
      s.AUTO_REPLY = 'disabled';  // Disable AUTO_REPLY_MESSAGE
      responseMessage = 'AUTO_REPLY_MESSAGE has been disabled successfully.';
      break;
...
adams({
  ...
  // Process command options and set ANTIDELETE status
  const option = arg.join(' ').toLowerCase();
  let responseMessage;

  switch (option) {
    case "yes":
      s.ANTIDELETE = 'enabled';  // Enable ANTIDELETE_MESSAGE
      responseMessage = 'ANTIDELETE_MESSAGE has been enabled successfully.';
      break;

    case "no":
      s.ANTIDELETE = 'disabled';  // Disable ANTIDELETE_MESSAGE
      responseMessage = 'ANTIDELETE_MESSAGE has been disabled successfully.';
      break;
...
adams({
  ...
  // Process command options and set AutoReact status
  const option = arg.join(' ').toLowerCase();
  let responseMessage;

  switch (option) {
    case "yes":
      s.AUTO_REACT = 'enabled';  // Enable AUTO_REACT
      responseMessage = 'AUTO_REACT has been enabled successfully.';
      break;

    case "no":
      s.AUTO_REACT = 'disabled';  // Disable AUTO_REACT
      responseMessage = 'AUTO_REACT has been disabled successfully.';
      break;
...
adams({
  ...
  // Process command options and set AutoReactStatus status
  const option = arg.join(' ').toLowerCase();
  let responseMessage;

  switch (option) {
    case "yes":
      s.AUTO_REACT_STATUS = 'enabled';  // Enable AUTO_REACT_STATUS
      responseMessage = 'AUTO_REACT_STATUS has been enabled successfully.';
      break;

    case "no":
      s.AUTO_REACT_STATUS = 'disabled';  // Disable AUTO_REACT_STATUS
      responseMessage = 'AUTO_REACT_STATUS has been disabled successfully.';
      break;
